...
public class CirclularMainButton extends View implements View.OnTouchListener {
    int progressStroke = 50;
    int progress = 180;
    Callback callback;

    public CirclularMainButton(Context context) {
        super(context);
        commonConstruct(context);
    }
    public CirclularMainButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        commonConstruct(context);
    }
